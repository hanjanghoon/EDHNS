...
train_path=new_data/train_SNDS_2000_0001.jsonl
val_path=ubuntu_data/valid_mdns.pkl
test_path=ubuntu_data/test_mdns.pkl
res_path=new_data/train_res_2000_0001.pkl

load_ckpt="runs/2312/ubuntu_FT_r1"
save_ckpt="runs/2312/ubuntu_FT_base"
...
nohup python3 -m torch.distributed.launch --nproc_per_node=16 \
    ...
    --seed 0 \
    --multi_task \
    --exp_name ${save_ckpt} > logs2312/ubuntu_FT_base.txt &