...
# checkpoint_path="runs/dstc10_knover/rl_02_256_gpu8_c2_rs120_kntrim/checkpoint-10034/pred_val.json"
# answer_path='dstc10_data/val/labels.json'
# dialog_path='dstc10_data/val/logs.json'

knowledge_path='dstc10_data/knowledge.json'
...
#dataset 
with open('dstc10_data/train/logs.json', 'r') as f:
    train_logs = json.load(f)

with open('dstc10_data/train/labels.json', 'r') as f:
    train_labels = json.load(f)

with open('dstc10_data/val/logs.json', 'r') as f:
    val_logs = json.load(f)

with open('dstc10_data/val/labels.json', 'r') as f:
    val_labels = json.load(f)

with open('dstc10_data/test/logs.json', 'r') as f:
    test_logs = json.load(f)

with open('dstc10_data/test/labels.json', 'r') as f:
