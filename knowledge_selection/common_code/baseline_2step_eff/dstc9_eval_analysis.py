...
# checkpoint_path="runs/dstc9_final/rlm_rr_05_256_seed0_rs12_3test_pa10_gpu12_long_bmen25/checkpoint-798/pred_test_seen.json"
...
checkpoint_path="runs/dstc9_test_part/rl_05_50_gpu8_bm25_500_rs32_eff99_seed404/checkpoint-909/pred_val.json"
...
def compare(pred, target, dialogs, knowledge,pure_test):
    ...
    for i in range(len(pred)):
        ...
        if True:#true_flag!=True:
            ...
            # if i in [246]:
            #     print()
            # best_list=[12, 22, 30, 31, 33, 52, 58, 60, 107, 108, 115, 145, 149, 158, 192, 194, 207, 210, 216, 219, 223, 232, 234, 258, 261, 275, 276, 283, 286, 294, 295]
            # #틀린거
            # if i not in best_list:
            #     if true_flag!=True:
            #         if target_key not in pure_test:
            #             print()
