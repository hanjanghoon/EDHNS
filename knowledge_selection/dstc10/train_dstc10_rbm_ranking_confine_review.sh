...
pre_model="roberta"
save_ckpt="dstc10_sample_wtest/rbm_1_50_sbert_562_gpu4_rs16_n3_seed713"
...
nohup python -m torch.distributed.launch --nproc_per_node=4 \
    ...
    --exp_name ${save_ckpt} > acl_log_dstc10_wtest/rbm_1_50_sbert_562_gpu4_rs16_n3_seed713.txt &
